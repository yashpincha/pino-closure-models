...
re=1e3 # inverse of coefficient of laplacian
lknm='ns1w' #'kf' or 'ns1w'

dsct=1 #spatial downsample rate when saving the tensor
L = 2*math.pi
s = 48 # spatial resolution.vor_save: s/dsct*s/dsct; 48 for hi reynolds case
N = 100 # total traj
bsize = 10 # traj per epoch

dt_save=1 #1/16

start_save=320
t_traj_phy=500
cs=2 #1:const cs; else(not 0): b,x,y Cs^2
dt0=1e2
alpha=2
